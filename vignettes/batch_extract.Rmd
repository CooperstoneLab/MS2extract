...
In the previous tutorial *Introduction to MS2extract package*, we described
in a detailed manner the core functions of the package. If you are starting
to use the MS2extract package with this tutorial, we encourage you to take 
a look at the aforementioned tutorial.

Now that you are familiar with the core workflow and core functions of this
package, now we can dive into an automated pipeline with the proposed
`batch_*()` functions.
...
and detecting mass. However, exporting the database in a msp file is able to
...
> **Tip:** you can specify point multiple compounds to the same mzXML.
