...
data frame used in `import_mzxml()`. This dataframe contains the
...
Although providing a retention time window is not mandatory,
it is highly suggested to provide this information to
have more control over the regions of the run that we look for the MS/MS
scans. If you do not provide a specific rt ROI, this package will
...
requierements, and it is discarded, while the second and third scan falls
