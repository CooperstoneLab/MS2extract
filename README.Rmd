...
your MS2 scans into a data frame. In this case we are going to work with the
...
In this case, the mzxml file contains only the scans in the retention time window
of Procyanidin A2 and `extract_MS2()` functions exports the most 
intense MS2 scans, and displays the TIC indicating which scan is
